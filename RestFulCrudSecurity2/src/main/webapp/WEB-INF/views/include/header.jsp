    ...
    <div class="sidebar">
      ...
      <sec:authorize access="isAuthenticated()">
	      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
	        ...
	        <div class="info">
	          <a href="#" class="d-block">${memberVO.memName}님</a>
	          <!-- 로그아웃 폼페이지 시작 -->
...
<%-- 	          	<sec:csrfInput/> --%>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- /// ROLE_USER + ROLE_ALBA 권한 시작, Any : or(또는) /// -->
          <sec:authorize access="isAuthenticated()">
          	<sec:authorize access="hasAnyRole('ROLE_USER','ROLE_ALBA')">
          <li class="nav-item">
          ...
          <!-- /// ROLE_USER + ROLE_ALBA 권한 끝 /// -->
          <!-- /// ROLE_ALBA 권한 시작 /// -->
          <sec:authorize access="isAuthenticated()">
          	<sec:authorize access="hasRole('ROLE_ALBA')">
