...
$(function(){
	...
	$("#btnPlus").on("click",function(){
		//model.addAttribute("lprodVO", lprodVO)
		let lprodGu = "${lprodVO.lprodGu}";//P201
			...
			success:function(result){
				...
				*/
				...
				let str = "<div class='row divProd'><div class='col-md-12'><div class='card card-primary'><div class='card-header'>";
					...
					{
					  "buyerList":[
						  map{"BUYER_ID": "P20101","BUYER_NAME": "대현"},
						  map{"BUYER_ID": "P20102","BUYER_NAME": "마르죠"}
								 ],
					  "maxProdId": "P201000022"
					}
					*/
					...
					str += "<input type='number' class='form-control' id='prodSale"+divProdLength+"' name='prodVOList["+divProdLength+"].prodSale' placeholder='상품 분류 코드' required /></div>";
