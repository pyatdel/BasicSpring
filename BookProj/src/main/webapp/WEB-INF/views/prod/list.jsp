				...
				<form>
					<div class="card-body">
						<div class="form-group">
							<label for="prodLgu">상품 분류 코드</label> <input type="text"
								class="form-control" id="prodLgu" placeholder="상품 분류 코드"
								maxlength="4" />
						</div>
						<div class="form-group">
							<label for="exampleInputPassword1">상품 분류 명</label> <input
	...
	function selectProdList(keyword) {
		...
		$.ajax({
			...
			success : function(result) {
				...
				//페이징 블록 처리
				$("#divPagingArea").html(
						"<center>" + result.pagingArea + "</center>");
