	...
	*/
	...
	public String createProdsPost(LprodVO lprodVO) {
		...
		lprodVO(lprodId=3, lprodGu=P201, lprodNm=null, fileGroupNo=0, uploadFile=null, fileGroupVO=null, 
			prodVOList=[
				ProdVO(prodId=P201000022, prodName=개똥이제과1, prodLgu=P201, prodBuyer=P20101, prodCost=0, prodPrice=0, prodSale=120000, prodOutline=제과제빵,..)
				ProdVO(prodId=P201000022, prodName=개똥이제과2, prodLgu=P201, prodBuyer=P20102, prodCost=0, prodPrice=0, prodSale=120001, prodOutline=ㅁㄴㅇㄹㄴㅁ,..) 
			]
		)
		 */
